...
def process_and_send_email(data):
    ...
    def query_llama3(subject):
        messages = [
            {"role": "system", 
             "content": "Generate an email body based on the following subject. Remove any [] and return only the body without any text else."},
...
# Example usage
#data = "subject:Congratulate asmaa to:ziadtarekmohamed32@gmail.com "
#process_and_send_email(data)
